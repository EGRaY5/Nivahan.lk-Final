...
if (isset($_SESSION['log_count'])){
    ...
    if(isset($_POST['contact'])){
        $profileDetails= mysqli_query($conn,"SELECT * FROM researcher WHERE userName = '".$_POST['contact']."'");
    ...
    while($row = mysqli_fetch_array($profileDetails)){
        ...
        $researchuni = $row['uni_research'];
        $university = $row['university'];
        $qualification = $row['qualification'];
    }

    $result = mysqli_query($conn,"SELECT * FROM research_projects WHERE userName='$userName';");
					...
					<div class="container-fluid">
					  ...
					  <div class="tab-content">
					    <div id="home" class="tab-pane fade in active">
                            ...
                            <h3><?php echo $researchArea;?></h3><br/><br/>

                            <h1>Research University</h1><br/>
                            <h3><?php echo $researchuni;?></h3><br/><br/>

                            <h1>University</h1><br/>
                            <h3><?php echo $university;?></h3><br/><br/>
